% Test oms decoder performance of different beta
clear;
...
for indx_snr = list_indx
    ...
    for indx_block = 1:MAX_BLOCK
        ...
        for indx_coef = list_indx_coef
            if(flag(indx_coef))
                decoded_bits = mex_nr15_fec_ldpc_decoder_oms_punctured(...
...
save('oms.mat','list_snr','list_ber');
