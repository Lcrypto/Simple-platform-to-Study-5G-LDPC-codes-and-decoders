function [ldpc_param] =ldpc_param_init(B,code_rate)
...
[H_BG, H_row, H_col, H] = ldpc_matrix_init(ldpc_param);
...
ldpc_param.k0 = 0;
ldpc_param.E = floor(K/code_rate) ; %the rate matching output sequence length  29 page 38.212 v15.3
